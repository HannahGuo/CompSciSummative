...
Player2 = Player2Robot.Player2(displayWidth - 150, displayHeight - 155 - (130 / 2), gameDisplay)
...
def gameLoop():
    ...
    while True:
        ...
        if not roboto.gotShot:
            ...
            if int(round(time.time() * 1000)) - Player2.lastShot >= Player2.randomInterval:
                Player2.shoot()
        ...
        if not Player2.gotShot:
            ...
            elif keys[pygame.K_D] and (Player2.x < 695) and not keys[pygame.K_LEFT]:
        ...
        if Player2.gotShot:
            Player2.ripPlayer2(Player2.hasRestarted)
